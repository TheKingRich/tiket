    ...
    <div class="container-md mt-5">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4 mt-3">
                <div class="card" style="height: 25rem;">
                    ...
                    <div class="card-body py-2">
                        <h4 class="card-title mb-2">Museum XYZ</h4>
                        <hr>
            ...
            <div class="col-12 col-md-6 col-lg-4 mt-3">
                <!-- Tinggi card 25rem -->
                <div class="card" style="height: 25rem;">
                    <img src="../assets/img/pantai.jpg" class="img-thumbnail" alt="Pantai" style="object-fit: cover; height: 225px;">
                    <div class="card-body py-2">
                        <h4 class="card-title mb-2">Pantai XYZ</h4>
                        <hr>
                        <p class="card-text mb-0">
                             Wisata : Pantai
                        </p>
            ...
            <div class="col-12 col-md-6 col-lg-4 mt-3">
                ...
                <div class="card" style="height: 25rem;">
                    ...
                    <div class="card-body py-2">
                        <h4 class="card-title mb-2">Taman Nasional XYZ</h4>
                        <hr>
                        <p class="card-text mb-0">
